...
- ✅ **НОВОЕ:** Архивирование новостей (скрытие без удаления)
- ✅ **НОВОЕ:** Горизонтальная прокрутка новостей с современным дизайном
- ✅ Управление партнерами (добавление, редактирование, удаление)
- ✅ Сортировка новостей и партнеров по порядку отображения
...
- ✅ Улучшенная совместимость с браузерами и мобильными устройствами
- ✅ Поддержка accessibility и touch-интерфейсов
...
- URL: `http://localhost:3000/admin` или `http://localhost:3000/admin/admin.html`
- Логин: `admin`
- Пароль: `fit012@13dka_a!34` (по умолчанию)
...
### Архивирование новостей
- Новости теперь можно отправлять в архив вместо удаления
- Архивные новости скрыты на сайте, но видны в админ-панели
- Возможность восстановления из архива
- Сохранение истории новостей

### Горизонтальная прокрутка новостей
- Современный слайдер с кнопками навигации
...
Подробнее см. [ARCHIVE_AND_SLIDER.md](ARCHIVE_AND_SLIDER.md)
